...
Data is stored directly in the Evolutionary Neural Memory database [StoreData Intent type]. Unlike StoreEvent, StoreData does not include tags. It is used for associating raw payload data with a unique identifier, timestamp, and location.
